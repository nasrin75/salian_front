!function (n) { "function" == typeof define && define.amd ? define(["jquery"], function (t) { return n(t, window, document) }) : "object" == typeof exports ? module.exports = function (t, e) { return t = t || window, e = e || ("undefined" != typeof window ? require("jquery") : require("jquery")(t)), n(e, t, t.document) } : n(jQuery, window, document) }(function (P, m, v, j) {
    ...
    function G(n) {
        ...
        var e = n.oClasses,
            ...
            s = (s = r.sSearch)
                .match(/_INPUT_/) ? s
                    .replace("_INPUT_", l) : s + l,
            e = P("<div/>", { id: i.f ? null : a + "_filter", class: e.sFilter })
                .append(P("<label/>")
                    .append(s)),
